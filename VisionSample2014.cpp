...
VisionSample2014::VisionSample2014(void){
	 ...
	 */
	bool VisionSample2014::ProcessImage(void)
	{
		Scores *scores;
		TargetReport target;
	 ...
	 */
	double VisionSample2014::ComputeDistance(BinaryImage *image, ParticleAnalysisReport *report) {
	 ...
	 */
	double VisionSample2014::ScoreAspectRatio(BinaryImage *image, ParticleAnalysisReport *report, bool vertical){
	 ...
	 */
	bool VisionSample2014::ScoreCompare(Scores scores, bool vertical){
		bool isTarget = true;
	 ...
	 */
	double VisionSample2014::ScoreRectangularity(ParticleAnalysisReport *report){
	 ...
	 */
	double VisionSample2014::RatioToScore(double ratio)
	{
	 ...
	 */
	bool VisionSample2014::HotOrNot(TargetReport target)
	{
		bool isHot = true;
